...
export default function Footer() {
  ...
  return (
    <footer className="bg-charcoal text-white/70 py-12 md:py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        {(weddingData.social.instagram || weddingData.social.twitter || weddingData.social.facebook) && (
          <div className="flex items-center justify-center gap-4 mb-8">
            {weddingData.social.instagram && (
              <a
        ...
        {/* Copyright */}
        <p className="font-body text-[10px] text-white/20 mt-4">
          &copy; {currentYear} {weddingData.groom.firstName} & {weddingData.bride.firstName}. All rights reserved.
        </p>
      </div>
    </footer>
  );
