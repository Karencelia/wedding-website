...
function GalleryItem({ image, index, onClick, inView }) {
  return (
    ...
    >
      <div className="aspect-[4/5] rounded-lg overflow-hidden bg-gradient-to-br from-rose-light/30 to-cream-dark relative">
        {/* Placeholder content */}
        <div className="absolute inset-0 flex flex-col items-center justify-center p-4">
          <div className="w-12 h-12 mb-3 rounded-full border border-rose-dusty/20 flex items-center justify-center">
...
function LightboxModal({ image, onClose }) {
  ...
  return (
    ...
    >
      ...
      <div
        className="max-w-2xl w-full aspect-[4/5] rounded-lg overflow-hidden bg-gradient-to-br from-rose-light/30 to-cream-dark flex items-center justify-center animate-scale-in"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="text-center p-8">
          <div className="w-20 h-20 mx-auto mb-4 rounded-full border border-rose-dusty/30 flex items-center justify-center">
            <svg className="w-8 h-8 text-rose-dusty/50" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
            </svg>
          </div>
